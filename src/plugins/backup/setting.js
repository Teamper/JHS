class SettingPlugin extends BasePlugin {
    ...
    async loadResourceSettings() {
        ...
        this.renderResourceSettings(); $("#enable115Offline").prop("checked", cloud.enable115Offline); $("#enable115Match").prop("checked", cloud.enable115Match); $("#enable115LoginRedirect").prop("checked", cloud.enable115LoginRedirect); $("#oneOneFiveConcurrency").val(cloud.concurrency); $("#oneOneFiveCacheMinutes").val(cloud.cacheMinutes); if (cloud.enable115Offline || cloud.enable115Match) this.checkOneOneFiveLogin();
    ...
    async saveCloudSettings() { await this.resourceSettings.saveCloudSettings({ enable115Offline: $("#enable115Offline").is(":checked"), enable115Match: $("#enable115Match").is(":checked"), enable115LoginRedirect: $("#enable115LoginRedirect").is(":checked"), concurrency: Number($("#oneOneFiveConcurrency").val()), cacheMinutes: Number($("#oneOneFiveCacheMinutes").val()) }); }
