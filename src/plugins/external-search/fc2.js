class le extends X {
    ...
    openFc2Dialog(e, t, n) {
        ...
        layer.open({
            ...
            scrollbar: !1,
            success: (i, s) => {
                organizeJhsOwnedDetailWorkspace($(i).find(".movie-detail-container")), this.loadData(e, t), $("#favoriteBtn").on("click", (async e => {
