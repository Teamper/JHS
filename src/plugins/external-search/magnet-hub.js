...
class MagnetHubPlugin extends BasePlugin {
    ...
    createMagnetHub(e) {
        ...
        this.searchEngines.forEach(((e, t) => {
            const n = $(`<button type="button" class="jhs-btn magnet-tab" role="tab" aria-selected="false" tabindex="-1" data-engine="${e.id}">${e.name}</button>`);
            i && e.id === i ? (n.addClass("active"), this.currentEngine = e, s = t) : 0 !== t || i || (n.addClass("active"),
            this.currentEngine = e), o.append(n);
        })), n.append(o), n.append(`<a class="jhs-btn jhs-btn--ghost" id="targetBox" href="${this.currentEngine.targetPage.replace("{keyword}", encodeURIComponent(e))}" target="_blank" rel="noopener noreferrer">原网页</a>`),
