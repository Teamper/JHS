class OneTwoThreeOfflinePlugin extends X {
    ...
    async resolveMagnet(e, t) {
        try {
            const n = await gmHttp.post(this._signUrl("https://www.123pan.com/b/api/v2/offline_download/task/resolve"), { urls: e }, {
    ...
    async submitTask(e, t) {
        ...
        try {
            const i = await gmHttp.post(this._signUrl("https://www.123pan.com/b/api/v2/offline_download/task/submit"), {
