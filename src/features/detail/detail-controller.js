...
export class DetailController {
    /** @param {{hostAdapter: any, nativePlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, workspacePlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, reviewPlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, relatedPlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, pageActionsPlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, magnetPlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, previewPlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, externalSitesPlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, screenshotPlugin?: {handle?: (options?: {scope: any}) => Promise<any> | any}, scope: import("../../core/lifecycle-scope.js").LifecycleScope, enabledContributions: readonly string[]}} options */
    constructor(options) {
