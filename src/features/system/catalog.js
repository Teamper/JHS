...
export const systemFeatureManifests = Object.freeze([
    ...
    defineFeature({
        ...
        requires: [SERVICE.profile], contributes: [], providesCommands: [], activate: (/** @type {any} */ deps) => ({ profile: deps[SERVICE.profile].current() }),
    }),
    defineFeature({
        id: "stats", kind: "system", disableable: false, sites: ["javdb", "javbus"], routes: [], startup: "idle",
        requires: [SERVICE.diagnostics], contributes: [], providesCommands: [],
