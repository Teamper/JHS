...
export class ListDomObserver {
    ...
    constructor(options) {
        ...
        this.onError = options.onError ?? ((error) => clog.error("列表增量处理失败", error));
