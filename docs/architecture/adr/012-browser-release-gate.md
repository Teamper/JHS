...
自动 smoke 不替代 Tampermonkey 人工发布 Gate。从 6.5.0 起，候选产物必须按 [人工 Smoke 记录契约](../../release/manual-smoke.md) 保存实际浏览器、Tampermonkey、真实页面结果和 UserScript SHA256；发布检查会拒绝缺失、失败或产物哈希不匹配的记录。
