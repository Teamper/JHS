...
const cases = JSON.parse(readTestFile(join(import.meta.dirname, "fixtures/media/cases.json"), "utf8"));
const helpers = readTestFile(join(import.meta.dirname, "../src/core/feature-helpers.js"), "utf8");
